...
const unsigned int frame_amount_x{15};
const unsigned int frame_amount_y{15};


extern const unsigned int element_size_x{80};
extern const unsigned int element_size_y{80};
